...
type: concept
tags: [banking, icaap, economic-capital, target-capital, stress-testing, pillar-2, raroc, regulation]
...
- $RWA_{IRRBB}$: Tổng tài sản rủi ro từ rủi ro lãi suất trên sổ ngân hàng do ngân hàng tự mô hình hóa; chậm nhất từ ngày 01/01/2028 bắt buộc phải tính toán dựa trên mức suy giảm giá trị kinh tế của vốn chủ sở hữu ($\Delta EVE$) theo hướng dẫn chi tiết tại [[irrbb-delta-eve-and-nii-standardized-measurement-governs-rate-shock-scenarios]] (sbv_circular_83_2025, file TT83.md, Phụ lục VI.I.1.iv, d.1906).
