...
- [[unencumbered-high-quality-liquid-asset-cushion-insures-against-stress-cash-flow-deficits]] — đệm tài sản thanh khoản cao unencumbered: định cỡ theo kết quả stress test, cơ cấu phân tầng (lõi tiền mặt/TPCP vs tài sản thị trường) và vai trò chốt chặn cuối cùng (Principle 12)
- [[liquidity-risk-public-disclosure-standards-mandate-qualitative-and-quantitative-market-transcipline]] — chuẩn mực công bố thông tin công khai Trụ cột 3: minh bạch định tính (ALM tập trung vs phân tán, stress test, CFP) và định lượng (cơ cấu đệm HQLA, chênh lệch kỳ hạn tích lũy) (Principle 13)
- [[supervisory-liquidity-review-process-evaluates-governance-stress-testing-and-cushion-adequacy]] — quy trình đánh giá giám sát thanh khoản (SREP thanh khoản): thẩm định toàn diện khung quản trị, kịch bản stress test sàn, giám sát thanh khoản trong ngày và Early Warning System liên thông với NHTW (Principle 14 & 15)
- [[supervisory-early-remedial-actions-mandate-liquidity-gap-reductions-and-capital-add-ons]] — can thiệp sớm và chế tài giám sát: thu hẹp funding gap, tăng đệm HQLA, đình chỉ M&A và yêu cầu vốn tự có bổ sung (capital add-on) (Principle 16)
- [[cross-border-supervisory-cooperation-and-crisis-information-sharing-contain-contagion]] — hợp tác giám sát xuyên biên giới và chia sẻ thông tin khủng hoảng: cơ chế Home - Host, thỏa thuận MoU và 8 sự kiện kích hoạt truyền thông khẩn cấp (Principle 17)

**Chuẩn mực Tỷ lệ Khả năng Chi trả & Công cụ Giám sát Rủi ro Thanh khoản (Basel III / BCBS 238)**
- [[basel-iii-lcr-short-term-liquidity-stress-framework-and-buffer-usability]] — khuôn khổ chuẩn mực LCR: kịch bản stress kết hợp 30 ngày (7 cú sốc), lộ trình phân kỳ 2015–2019 (60% $\to$ 100%) và nguyên tắc sử dụng đệm HQLA chống nghịch chu kỳ
- [[hqla-fundamental-and-market-characteristics-govern-asset-liquidity-qualification]] — tiêu chuẩn định tính và định lượng xác định HQLA: 4 đặc tính cơ bản (rủi ro thấp, chắc chắn định giá, không wrong-way, niêm yết), 3 đặc tính thị trường và vai trò của Central Bank Eligibility
- [[hqla-operational-requirements-enforce-unencumbered-status-and-treasury-control]] — yêu cầu vận hành HQLA: tình trạng unencumbered, quy tắc thứ tự giải tỏa tài sản trong pool tại NHTW (Footnote 9), kiểm soát độc quyền Treasury/ALM, kiểm tra thanh lý thực tế, xử lý hedging và ân hạn 30 ngày
- [[hqla-asset-categorisation-and-haircut-parameters-define-liquidity-tiers]] — phân tầng tài sản HQLA và tham số haircut: Level 1 (haircut 0%), Level 2A (haircut 15%), Level 2B (haircut 25% cho RMBS đủ chuẩn, haircut 50% cho corporate debt và cổ phiếu phổ thông)
- [[hqla-unwinding-mechanics-and-cap-formulas-eliminate-short-term-financing-distortions]] — công thức toán học chuẩn xác tuyệt đối Annex 1: cơ chế đảo ngược giao dịch SFT và hoán đổi TSBĐ $\le 30$ ngày, công thức tính trần 40% Level 2 và trần 15% Level 2B
- [[alternative-liquidity-approaches-ala-resolve-jurisdictional-hqla-structural-deficits]] — phương pháp thanh khoản thay thế ALA cho các quốc gia thiếu hụt HQLA nội tệ: tiêu chuẩn đánh giá ngang hàng, Option 1 (CLF có phí), Option 2 (HQLA ngoại tệ kèm FX haircut), Option 3 (Level 2A vượt trần) và cơ chế Sukuk
- [[central-bank-liquidity-facilities-provide-contingent-backstops-against-funding-shocks]] — cơ sở cung cấp thanh khoản của NHTW (tái cấp vốn & hạn mức cam kết CLF): điểm tựa dự phòng khẩn cấp chống sốc đóng băng liên ngân hàng
- [[basel-iii-retail-deposit-run-off-framework-differentiates-stable-and-less-stable-funds]] — phân tầng tiền gửi bán lẻ: stable (5%, hoặc 3% nếu đạt 4 chuẩn bảo hiểm nghiêm ngặt), less stable (10%+), SME $< 1$M EUR và loại trừ tiền gửi có kỳ hạn $\ge 30$ ngày
- [[operational-deposits-framework-evaluates-clearing-custody-and-cash-management-stickiness]] — tiền gửi hoạt động (25% run-off): 3 nhóm dịch vụ (clearing, custody, cash management), hợp đồng $\ge 30$ ngày/chi phí chuyển đổi cao, bóc tách excess balance và cấm correspondent banking/prime brokerage
- [[unsecured-wholesale-funding-run-off-matrices-calibrate-counterparty-flight-risk]] — ma trận rút vốn bán buôn không bảo đảm: doanh nghiệp phi tài chính/sovereign/PSE (20% có bảo hiểm, 40% thường), định chế tài chính (100%), nợ phát hành (100%) và mạng lưới ngân hàng hợp tác (25%/100%)
- [[secured-funding-run-off-mechanics-map-collateral-hierarchy-and-counterparty-profiles]] — cơ chế rút vốn tài trợ có bảo đảm (Repo run-off): Level 1/NHTW (0%), Level 2A (15%), RMBS và MDB/PSE rủi ro $\le 20\%$ (25%), Level 2B khác (50%), phi HQLA/vị thế bán khống (100%)
- [[contingent-liquidity-outflow-shocks-quantify-downgrades-derivatives-and-facility-drawdowns]] — cú sốc dòng tiền ngoại bảng và nghĩa vụ tiềm ẩn: hạ 3 bậc tín nhiệm (100%), Lookback 24 tháng cho phái sinh Netting, haircut 20% TSBĐ phi Cấp 1, ma trận rút hạn mức cam kết tín dụng/thanh khoản (5%–100%) và tài trợ thương mại (3%–5%)
- [[basel-iii-cash-inflows-and-75-percent-cap-framework-safeguards-minimum-hqla-buffer]] — khung đo lường dòng tiền vào và trần khống chế 75%: công thức $\min(\text{Inflows}, 0{,}75 \times \text{Outflows})$, cưỡng chế đệm sàn HQLA tối thiểu 25% dòng tiền ra, loại trừ dòng tiền tiềm năng và doanh thu phi tài chính
- [[secured-lending-and-counterparty-cash-inflow-matrices-calibrate-rehypothecation-risk]] — ma trận dòng tiền vào cho vay có bảo đảm: Reverse Repo Level 1 (0%), Level 2A (15%), RMBS (25%), Level 2B khác (50%), phi HQLA (100%), ngoại lệ rehypothecation/bán khống (0%), phân tầng đối tác (bán lẻ/doanh nghiệp 50%, định chế 100%) và 0% hạn mức cam kết/tiền gửi hoạt động
- [[consolidated-lcr-cross-border-framework-regulates-home-host-discretion-and-trapped-liquidity]] — khuôn khổ LCR hợp nhất xuyên biên giới: tần suất báo cáo tháng $\to$ tuần/ngày khi stress, phân định Home - Host (bắt buộc dùng host parameters cho tiền gửi bán lẻ), loại bỏ hoàn toàn thanh khoản thặng dư bị giam lỏng (trapped liquidity) và giám sát đồng tiền trọng yếu $\ge 5\%$
- [[basel-iii-liquidity-risk-monitoring-tools-complement-contractual-and-market-oversight]] — hệ thống 5 công cụ giám sát rủi ro thanh khoản bổ trợ: chênh lệch kỳ hạn hợp đồng 13 dải thời gian, nợ tập trung đối tác/sản phẩm $> 1\%$, tài sản khả dụng không bị ràng buộc (monetized value), LCR ngoại tệ trọng yếu $\ge 5\%$ và chỉ báo thị trường 3 cấp độ
- [[alternative-liquidity-approaches-eligibility-assessment-principles-and-governance]] — nguyên tắc đánh giá tư cách hợp lệ và quản trị ALA (Annex 2 & 3): 3 nguyên tắc nền tảng (thiếu hụt HQLA nội tệ thực chất, kiểm soát rủi ro Option 1/2/3, cam kết giám sát), rà soát 5 năm và đánh giá ngang hàng độc lập
- [[basel-iii-lcr-master-factor-matrix-and-comprehensive-calibration-architecture]] — ma trận tham số chuẩn tắc và kiến trúc toán học hoàn chỉnh (Annex 1 & 4): tích hợp phân tầng HQLA (haircut 0%–50%), dòng tiền ra (3%–100%), dòng tiền vào (0%–100%), cơ chế Unwinding SFT $\le 30$ ngày, trần 40% Level 2, trần 15% Level 2B và trần dòng tiền vào 75%

**Chuẩn mực Quản trị & Đo lường Rủi ro Lãi suất trên Sổ Ngân hàng (IRRBB / BCBS 368)**
- [[irrbb-board-and-senior-management-governance-framework-enforces-delegation-and-independence]] — khuôn khổ quản trị IRRBB: trách nhiệm giải trình tối cao của HĐQT, cơ cấu năng lực kỹ thuật, cơ chế ủy quyền cho ALCO, phân định độc lập Tuyến 2 với Tuyến 1 và chế độ báo cáo bán niên/thường xuyên (Principle 2 & 7)
- [[irrbb-risk-appetite-framework-establishes-multi-tiered-limits-and-escalation-protocols]] — khung khẩu vị rủi ro và hạn mức đa tầng: Tuyên bố khẩu vị rủi ro RAS định lượng cả EVE và NII, hạn mức cấp tập đoàn hợp nhất vs công ty con, tiểu hạn mức cho Gap/Basis/Option, phê duyệt phòng hộ phái sinh và quy trình leo thang cưỡng chế (Principle 3)
- [[irrbb-stress-testing-architecture-integrates-multi-tier-scenarios-and-reverse-stress-testing]] — kiến trúc kiểm tra áp lực IRRBB: 4 tầng kịch bản (ICAAP nội bộ, lịch sử/giả định, 6 kịch bản sốc chuẩn hóa Annex 2, kịch bản giám sát), mô hình hóa lãi suất âm NIRP, tương tác rủi ro tín dụng/thanh khoản và kỹ thuật Reverse Stress Testing định tính/định lượng (Principle 4)
- [[non-maturity-deposit-behavioural-modelling-governs-core-and-non-core-segmentation-under-irrbb]] — mô hình hóa hành vi tiền gửi không kỳ hạn NMDs: bóc tách số dư thành Core deposits (ổn định, không định giá lại) và Non-core deposits, phân tầng theo Bán lẻ vs Bán buôn và Giao dịch vs Phi giao dịch, hệ số pass-through beta và rà soát tham số hàng năm (Principle 5)
- [[customer-behavioural-optionalities-govern-loan-prepayments-and-early-deposit-redemptions]] — mô hình hóa các quyền chọn hành vi khách hàng: ước lượng tốc độ trả nợ trước hạn CPR cho vay cố định (phụ thuộc LTV, quy mô, biến số vĩ mô GDP/lạm phát/thất nghiệp/HPI), cam kết giải ngân mortgage pipeline, rủi ro rút tiền gửi có kỳ hạn sớm và tác động của caps/floors ngầm định trong khoản vay thả nổi (Principle 5)
- [[irrbb-internal-measurement-systems-mandate-three-pillar-model-risk-validation]] — hệ thống đo lường nội bộ IMS và quản trị rủi ro mô hình: tính toàn vẹn dữ liệu, tiêu chí slotting dải kỳ hạn ổn định, 3 trụ cột kiểm định độc lập (Conceptual soundness, Ongoing monitoring/benchmarking, Outcomes analysis/backtesting), quản trị vendor models và kiểm toán nội bộ (Principle 6)
- [[irrbb-multi-currency-aggregation-governs-cross-currency-interest-rate-correlations]] — quy tắc tổng hợp rủi ro đa tiền tệ: đo lường độc lập theo từng đồng tiền trọng yếu, giả định hệ số tương quan chéo, kiểm soát nguy cơ đứt gãy tương quan (correlation breakdown) khi stress và nguyên tắc cộng gộp thận trọng của giám sát (Principle 4 & 5)
- [[irrbb-capital-adequacy-and-business-alignment-integrate-into-icaap-framework]] — tích hợp IRRBB vào ICAAP và kế hoạch kinh doanh: lồng ghép vào chu kỳ lập ngân sách, thẩm định rủi ro tiền khả thi (preacquisition review) cho sản phẩm mới, phân bổ vốn kinh tế cho rủi ro EVE và thiết lập đệm vốn (capital buffer) cho rủi ro suy giảm thu nhập NII (Principle 1 & 4)
- [[pillar-3-irrbb-qualitative-disclosure-standards-mandate-table-a-narratives]] — chuẩn mực công bố thông tin định tính Trụ cột 3: Bảng A bắt buộc 8 nội dung thuyết minh chiến lược, rủi ro mô hình, kỹ thuật phòng hộ và 2 chỉ tiêu định lượng bắt buộc về NMDs (Principle 8)
- [[pillar-3-irrbb-quantitative-disclosure-standards-mandate-table-b-metrics]] — chuẩn mực công bố thông tin định lượng Trụ cột 3: Bảng B báo cáo ma trận cố định ΔEVE và ΔNII qua kỳ T và T-1 dưới 6 kịch bản sốc chuẩn hóa và Vốn cấp 1 ghi nhớ (Principle 8)
- [[delta-eve-regulatory-calculation-rules-mandate-run-off-and-equity-exclusion]] — quy tắc kỹ thuật tính toán ΔEVE giám sát: loại trừ hoàn toàn vốn tự có, phạm vi tài sản không bị trừ CET1, chiết khấu bằng đường cong phi rủi ro không spread và giả định run-off (Principle 8 & 9)
- [[delta-nii-regulatory-calculation-rules-mandate-constant-balance-sheet-and-rolling-horizon]] — quy tắc kỹ thuật tính toán ΔNII giám sát: bao gồm biên độ thương mại, giả định bảng cân đối không đổi (constant balance sheet) và đo lường biến thiên 12 tháng lăn kỳ (Principle 8 & 9)
- [[irrbb-capital-allocation-framework-differentiates-economic-capital-from-earnings-buffers]] — phân bổ vốn IRRBB trong ICAAP: phân định Vốn kinh tế bù đắp rủi ro EVE dài hạn và Đệm vốn bù đắp rủi ro NII ngắn hạn, xử lý 9 nhân tố trọng yếu và trapped capital (Principle 9)
- [[supervisory-outlier-test-mandates-fifteen-percent-tier-one-capital-threshold]] — bài kiểm tra tổ chức ngoại lai SOT: ngưỡng sụt giảm EVE tối đa 15% Vốn cấp 1 dưới 6 kịch bản sốc lãi suất chuẩn hóa Annex 2 và thẩm quyền bổ sung bài kiểm tra NII (Principle 12)
- [[supervisory-remedial-actions-mandate-exposure-reduction-capital-add-ons-and-parameter-constraints]] — chế tài can thiệp giám sát cưỡng chế: 4 biện pháp can thiệp sớm gồm giảm phơi nhiễm rủi ro, tăng vốn Trụ cột 2 add-on, khống chế tham số nội bộ và cưỡng chế áp dụng Khung chuẩn hóa (Principle 12)
- [[supervisory-review-process-srep-enforces-peer-benchmarking-and-cross-border-cooperation-for-irrbb]] — quy trình đánh giá giám sát SREP cho IRRBB: thẩm định năng lực quản trị, so sánh ngang hàng (peer benchmarking) và cơ chế phối hợp giám sát xuyên biên giới Home - Host (Principle 10 & 11)
- [[irrbb-standardised-framework-five-stage-measurement-architecture]] — kiến trúc đo lường chuẩn hóa 5 giai đoạn: phân loại công cụ theo khả năng chuẩn hóa (Stage 1), slotting 19 dải kỳ hạn (Stage 2), tính ΔEVE cơ sở (Stage 3), định giá lại toàn diện quyền chọn tự động sốc biến động ngầm định +25% KAO (Stage 4) và tổng hợp đa tiền tệ (Stage 5) (Section IV.1)
- [[standardised-repricing-cash-flow-bucketing-and-nineteen-tenor-schedule]] — lịch 19 dải kỳ hạn chuẩn hóa: bảng tọa độ điểm giữa (t_k từ 0.0028Y đến 25Y), quy tắc phân rã dòng tiền định giá lại gốc/lãi, tách biên thương mại, xử lý công cụ thả nổi và kiểm soát rủi ro không khớp kỳ hạn nội dải (Section IV.2.1)
- [[standardised-nmd-categorisation-and-core-deposit-caps-framework]] — khung phân tầng NMDs và trần tiền gửi lõi chuẩn hóa: phân đoạn bán lẻ vs bán buôn, giao dịch vs phi giao dịch, quy trình 2 bước tách stable/core trên chuỗi 10 năm, trần tỷ trọng core (90%/70%/50%), trần kỳ hạn bình quân (5Y/4.5Y/4Y) và dồn non-core vào dải qua đêm (Section IV.3)
- [[standardised-loan-prepayment-modelling-and-cpr-multipliers]] — mô hình hóa trả nợ trước hạn chuẩn hóa cho vay bán lẻ cố định: tỷ lệ trả trước có điều kiện cơ sở CPR_0, ma trận hệ số nhân kịch bản γ_i (0.8 khi lãi suất tăng/dốc, 1.2 khi lãi suất giảm/phẳng) và thuật toán phân rã dòng tiền định kỳ/trả trước (Section IV.4)
- [[standardised-term-deposit-early-redemption-risk-and-tdrr-scalars]] — đo lường chuẩn hóa rủi ro rút tiền gửi có kỳ hạn sớm: tiêu chuẩn pháp lý/kinh tế phân loại nợ cố định, tỷ lệ rút trước hạn cơ sở TDRR_0, ma trận hệ số vô hướng u_i (1.2 khi lãi suất tăng/phẳng, 0.8 khi lãi suất giảm/dốc) và cơ chế dồn dòng tiền vào dải qua đêm (Section IV.4)
- [[automatic-interest-rate-options-standardised-valuation-and-volatility-shocks]] — định giá chuẩn hóa quyền chọn lãi suất tự động và cú sốc độ biến động: tái định giá toàn diện (full revaluation) quyền chọn bán và quyền chọn mua phòng hộ dưới cú sốc kép đường cong lãi suất và tăng tương đối +25% độ biến động ngầm định, xác định phần bù rủi ro KAO (Section IV.5)
- [[standardised-delta-eve-calculation-and-multi-currency-aggregation-rules]] — thuật toán tính toán ΔEVE chuẩn hóa và tổng hợp đa tiền tệ: bù trừ ròng nội dải, hệ số chiết khấu liên tục lãi suất phi rủi ro DF(t_k), tích hợp KAO, quy tắc tổng hợp đa tiền tệ chuẩn tắc Basel vs quy tắc giám sát thận trọng bảo thủ, và xác định mức sụt giảm EVE tối đa (Section IV.6)
- [[interest-rate-theoretical-decomposition-and-csrbb-boundary]] — mô hình phân rã lý thuyết 5 thành tố lãi suất: lãi suất phi rủi ro, phần bù thời lượng, phần bù thanh khoản, credit spread thị trường chung và credit spread đặc thù; ranh giới pháp lý phân định IRRBB vs CSRBB và loại trừ rủi ro vỡ nợ nhảy bậc (Annex 1.1.3–1.4)
- [[equity-endowment-effect-and-replicating-portfolio-in-alm]] — hiệu ứng lợi suất thừa kế vốn tự có và kỹ thuật danh mục mô phỏng: bản chất cấu trúc của vốn chủ sở hữu và NMDs, kỹ thuật replicating portfolio tái đầu tư cuốn chiếu liên tục, sự đánh đổi tất yếu giữa ổn định NII vs rủi ro EVE, và nguyên tắc loại trừ vốn tự có của giám sát (Annex 1.3.4–3.5)
- [[economic-value-at-risk-evar-framework-and-alm-simulation-techniques]] — khuôn khổ giá trị kinh tế chịu rủi ro EVaR và các kỹ thuật mô phỏng ALM: phân tích khe hở định giá lại (PV01/Duration), EVE, 3 kỹ thuật EVaR (mô phỏng lịch sử, ma trận hiệp phương sai, Monte Carlo) và mô phỏng thu nhập động (Annex 1.4)
- [[six-standardised-interest-rate-shock-scenarios-and-mathematical-formulations]] — hệ thống 6 kịch bản sốc lãi suất chuẩn hóa và công thức toán học: hàm định hình suy giảm kỳ hạn S_short(t_k) = exp(-t_k/4), công thức sốc song song, ngắn hạn, cú sốc dốc Steepener (-0.65 short + 0.9 long) và phẳng Flattener (+0.8 short - 0.6 long), ma trận tham số các đồng tiền chính và sàn sau sốc (Annex 2)
- [[interest-rate-shock-calibration-methodology-global-scalars-and-caps-floors]] — phương pháp luận hiệu chuẩn sốc lãi suất, tham số toàn cầu và hệ thống trần-sàn: chuỗi số liệu lịch sử 16 năm (2000–2015), bộ ba hệ số toàn cầu cơ sở (60%, 85%, 40%), sàn bắt buộc 100 bps và hệ thống trần (400, 500, 300 bps), ứng dụng cho các đồng tiền nội tệ và chu kỳ tái hiệu chuẩn 5 năm (Annex 2)
- [[accounting-treatment-of-banking-book-amortised-cost-versus-fair-value-under-irrbb]] — hạch toán kế toán sổ ngân hàng (Giá trị phân bổ Amortised cost vs Giá trị hợp lý Fair value/FVOCI): bóc tách bản chất lỗ kinh tế ΔEVE ngầm định không phản ánh ngay lên P&L, rủi ro biến thành lỗ thực tế khi căng thẳng thanh khoản buộc phải bán tài sản (Annex 1.1.2)
- [[replicating-portfolio-optimization-methodology-for-nmds-and-equity]] — phương pháp luận tối ưu hóa danh mục mô phỏng cho NMDs và vốn chủ sở hữu: bài toán tối ưu hóa bậc hai quadratic programming cực tiểu hóa phương sai chênh lệch lãi suất min Var(R_rep - r_dep), ràng buộc trần Bảng 2 Basel và kỹ thuật tái đầu tư cuốn chiếu 1/M (Annex 1.3.4–3.5, Footnote 38)
- [[pre-acquisition-review-and-hedging-approval-governance-for-irrbb]] — quy trình thẩm định rủi ro tiền khả thi (pre-acquisition review) cho sản phẩm mới và quản trị phê duyệt phòng hộ: 5 tiêu chuẩn thẩm định, nhận diện quyền chọn ngầm định, phê duyệt chiến lược phòng hộ ALCO/HĐQT và đo lường hiệu quả định kỳ (Principle 1, 3 & 7)
- [[trapped-capital-and-cross-border-transferability-constraints-under-irrbb]] — rào cản chuyển dịch vốn tự có và thanh khoản xuyên biên giới (trapped capital): 4 rào cản pháp lý/ngoại hối/thuế, cấm bù trừ cơ học trong ICAAP hợp nhất và cơ chế hợp tác giám sát Home - Host (Principle 9 & 10)
- [[reverse-stress-testing-quantitative-and-qualitative-mechanisms-for-irrbb]] — cơ chế kiểm tra sức chịu đựng ngược (Reverse Stress Testing) cho IRRBB: định vị ngưỡng đổ vỡ break-point (sụt giảm 100% Vốn cấp 1 hoặc vi phạm SOT 15%), thuật toán tối ưu hóa ngược tìm vector sốc tối thiểu, đứt gãy tương quan và tương tác đa rủi ro Lãi suất - Tín dụng - Thanh khoản (Principle 4)
- [[yield-curve-interpolation-and-discounting-mechanics-in-alm]] — cơ chế nội suy đường cong lợi suất và kỹ thuật chiết khấu dòng tiền trong ALM: phương pháp bootstrapping zero-coupon, so sánh Cubic Spline vs Nelson-Siegel-Svensson, hệ số chiết khấu liên tục exp(-R*t_k), kỹ thuật xử lý lãi suất âm NIRP và cơ chế sàn giám sát phi tuyến tính (Section IV.6 & Annex 2)
- [[effective-duration-and-effective-convexity-for-banking-book-optionalities]] — độ thời lượng hiệu dụng (Effective Duration) và độ lồi hiệu dụng (Effective Convexity) cho các vị thế có quyền chọn trong sổ ngân hàng: sự đổ vỡ của Macaulay/Modified Duration khi dòng tiền biến động theo lãi suất, phương pháp sai phân tái định giá hai chiều, hiện tượng độ lồi âm (negative convexity) và Key Rate Effective Duration (Annex 1.2.2)
- [[balance-sheet-dynamics-assumptions-run-off-constant-and-dynamic-in-alm]] — ba giả định động thái bảng cân đối kế toán trong ALM: Run-off (bắt buộc cho ΔEVE Trụ cột 2 & 3), Constant (bắt buộc cho ΔNII 12 tháng Trụ cột 3) và Dynamic (áp dụng cho ICAAP và mô phỏng kế hoạch kinh doanh nội bộ) (Section I, Principle 4 & Annex 1.3)
- [[funds-transfer-pricing-as-an-irrbb-risk-transfer-and-steering-mechanism]] — định giá chuyển nhượng vốn nội bộ (FTP) như công cụ điều chuyển và điều hướng rủi ro IRRBB: cô lập rủi ro hoán đổi kỳ hạn về Treasury, bóc tách đa thành phần (Base, Liquidity, Basis, Option charge), định giá FTP cho NMDs qua danh mục mô phỏng và công cụ điều tiết bảng cân đối (Principle 3 & Annex 1.2.6)
