...
(imf_macro_accounting, Ch.5, cùng mục, d.4640–4645 — nguồn bị mất số hạng $CPS^*$ do lỗi OCR; chỉ còn 4/5 khoản mục, không tự suy diễn số hạng thiếu). Đây là công cụ phân rã dùng trong [[monetizing-the-deficit-creates-high-powered-money-and-inflation|phân tích tiền tệ hoá thâm hụt]] và trong [[financial-programming|chương trình tài chính]] của IMF để theo dõi nguồn gốc mở rộng tiền tệ. Bản thân RM không phải khối tiền lưu hành trong nền kinh tế — [[the-money-multiplier-links-reserve-money-to-the-money-supply|số nhân tiền]] mới là cầu nối biến một đơn vị tiền cơ sở thành một bội số tương ứng của khối tiền.
