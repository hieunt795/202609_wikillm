...
Chênh lệch lợi suất này càng lớn khi: (i) khoảng cách haircut $h_B - h_A$ càng rộng; (ii) độ biến động của các cú sốc thanh khoản $\sigma_k^2$ càng cao; và (iii) mức độ phụ thuộc cấu trúc của hệ thống ngân hàng vào thanh khoản NHTW càng lớn (d.1797). Các nghiên cứu gần đây (Koulischer & Struyven 2013; Bindseil 2013; Majnoni d'Intignano 2013) đều xác nhận việc nới lỏng chính sách tài sản bảo đảm của NHTW là biện pháp hữu hiệu giúp hạ nhiệt lãi suất thị trường và phá vỡ tình trạng đóng băng tín dụng, đặc biệt khi chính sách lãi suất bị chặn bởi [[one-directional-standing-facility-monetary-policy|lãi suất sàn danh nghĩa (ZLB)]]. Đáng chú ý, các nấc haircut của ngân hàng trung ương thường được quy đổi cơ học từ các thang đo xếp hạng tín nhiệm của các cơ quan ECAI, khiến các hiện tượng dịch chuyển xếp hạng và nguy cơ rớt chuẩn đầu tư kích hoạt bán tháo cưỡng bức theo phân tích tại [[credit-ratings-represent-ordinal-ranking-scales-distorted-by-the-issuer-pays-conflict-and-curse-of-the-commons]] và [[rating-migration-matrices-resolve-the-maturity-paradox-and-reveal-corporate-versus-sovereign-risk-divergence]]. Đồng thời, đối với các cấu trúc chứng khoán hóa, ngân hàng trung ương áp đặt các tiêu chuẩn minh bạch nghiêm ngặt tới từng khoản nợ riêng lẻ (loan-level data) để công nhận tài sản thế chấp đủ điều kiện theo phân tích tại [[asset-backed-securitization-achieves-bankruptcy-remoteness-via-true-sale-and-non-recourse-spvs]].
