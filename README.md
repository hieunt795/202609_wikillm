...
- **[LLM Wiki](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f)** (Andrej Karpathy) — mô hình 3 lớp nguồn/wiki/schema, ba operation ingest · query · lint (dự án thêm promote để quản vòng đời trang). LLM là người biên tập giữ một cơ sở tri thức tích luỹ, thay cho việc RAG lại từ đầu mỗi lần hỏi.
...
| Quy trình thực thi từng operation | `.claude/skills/{ingest,query,lint,promote}/SKILL.md` |
