...
- [2026-09-15] Nợ chú thích §7.5: 24/51 trang tạo ngày 2026-09-12 chưa có chú thích vị trí nguồn. Nợ này hết dần khi Ch.2 được viết lại theo cụm (A1 xong). Không backfill hàng loạt; trả dần khi trang được sửa nội dung (hook đòi chú thích với `last_updated` ≥ 2026-09-14).
